...
"C:\Program Files\IAR Systems\Embedded Workbench 5.0 Evaluation\common\bin\cspybat" "C:\Program Files\IAR Systems\Embedded Workbench 5.0 Evaluation\ARM\bin\armproc.dll" "C:\Program Files\IAR Systems\Embedded Workbench 5.0 Evaluation\ARM\bin\armsim.dll"  %1 --plugin "C:\Program Files\IAR Systems\Embedded Workbench 5.0 Evaluation\ARM\bin\<libsupport_plugin>" --backend -B "--endian=little" "--cpu=Cortex-M3" "--fpu=None" "-p" "C:\Program Files\IAR Systems\Embedded Workbench 5.0 Evaluation\ARM\CONFIG\debugger\ST\iostm32f10xxb.ddf" "--semihosting" "--device=STM32F10xxB" "-d" "sim" 
